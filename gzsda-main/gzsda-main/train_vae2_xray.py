...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        for iteration, (xS,xT,yS,yT) in enumerate(data_loaders['train']):
            #print('xsSORI',xS.shape)
            ##print('xtSORI',xT.shape)
            ##print('ysSORI',yS.shape)
            #print('ytSORI',yT.shape)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--decoder_layer_sizes", type=list, default=[512, 904])##########
